...
{
    public partial class ArqInf : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayPerHour = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VacationDaysGiven = table.Column<DateTime>(type: "datetime2", nullable: true),
                    VacationDays = table.Column<int>(type: "int", nullable: true),
                    VacationPendent = table.Column<bool>(type: "bit", nullable: true),
                    InVacation = table.Column<bool>(type: "bit", nullable: true),
                    VacationAccepted = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignment_AspNetUsers_AssignerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectAssignments_Assignment_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "Assignment",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectAssignments_Project_ProjectId",
