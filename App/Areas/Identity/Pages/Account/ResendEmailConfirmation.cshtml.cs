...
namespace ArqInf.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Conta com email fornecido não existe.");
                return Page();
            }
            ...
            if (!_userManager.IsEmailConfirmedAsync(user).Result)
            {
                ...
                ModelState.AddModelError(string.Empty, "Email de confirmação enviado com sucesso");
            }
            else
            {
                ModelState.AddModelError(string.Empty, "A conta já se encontra confirmada.");
            }
