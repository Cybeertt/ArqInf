...
namespace IntegrationTests
{
    ...
    public class addrejectVacationTest
    {
        private readonly WebApplicationFactory<Program> _factory;
        private readonly HttpClient _client;

        public addrejectVacationTest()
        {
        ...
        [Fact]
        public async Task Accept_Vacation_User_login()
        {
        ...
        [Fact]
        public async Task make_Vacation_User_CanAccessPage()
        {
            ...
            var httpResponse = await _client.GetAsync("/Identity/Account/Manage");
            var httpResponse2 = await _client.GetAsync("/User/BookVacation/a816910b-d96b-4590-948e-2393d4f562af");
            // Assert: 
        ...
        /*[Fact]
        public async Task Reject_Vacation_User_login()
        {
            var httpResponse = await _client.GetAsync("/Identity/Account/Manage");
        ...
        [Fact]
        public async Task Reject_Vacation_User_CanAccessPage()
        {
            UserAthentication userLogin = new UserAthentication(_client);
            userLogin.AuthenticateUser("rafaelbpalma@gmail.com", "Escola@123").Wait();
            ...
            //var httpResponse = await _client.GetAsync("/Users");
            var httpResponse = await _client.GetAsync("/Identity/Account/Manage");
            var httpResponse2 = await _client.GetAsync("/Manager/PendentVacations");
            // Assert: 
            Assert.Equal(HttpStatusCode.OK, httpResponse.StatusCode);
            Assert.Equal(HttpStatusCode.OK, httpResponse2.StatusCode);
        }*/
