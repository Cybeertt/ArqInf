...
namespace IntegrationTests
{
    ...
    public class costtimeTest
    {
        ...
        [Fact]
        public async Task Access_Time_Task_Project_User_login()
        {
        ...
        [Fact]
        public async Task Access_Time_Task_Project_User_CanAccessPage()
        {
       ...
       /* [Fact]
        public async Task add_Cost_Task_Project_User_login()
        {
            var httpResponse = await _client.GetAsync("/Identity/Account/Manage");
        ...
        [Fact]
        public async Task add_Cost_Task_Project_User_CanAccessPage()
        {
            UserAthentication userLogin = new UserAthentication(_client);
            userLogin.AuthenticateUser("rafaelbpalma@gmail.com", "Escola@123").Wait();
